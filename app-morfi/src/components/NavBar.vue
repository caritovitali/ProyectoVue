<template lang="html">
 <div>
    ...
    <nav class="flex justify-between bg-gray-600 text-white w-screen">
      <div class="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          <li> <router-link to="/" class="hover:text-gray-200">Productos</router-link> </li>
          <li> <router-link class="hover:text-gray-200" to="/pedidos">Mis pedidos</router-link> </li>
        ...
        <div class="hidden xl:flex items-center space-x-5 items-center">
          ...
          <a class="flex items-center hover:text-gray-200" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
               ...
               <a class="flex items-center hover:text-gray-200" href="#" @click="showLogin=true">
                 Login
          </a>
        </div>
      </div>
  ...
  <LoginModal v-show="showLogin" @iniciar-sesion="iniciarSesion"  />
 </div>
